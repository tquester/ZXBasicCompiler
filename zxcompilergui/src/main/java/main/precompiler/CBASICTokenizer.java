			...
			if (c == '\\') {
				...
				if (Character.isDigit(c)) {
					...
					if (str.startsWith("INK")) 
						{mTemp[mLength++] = 0x10; p+=3;}
					else if (str.startsWith("PAPER")) 
						{mTemp[mLength++] = 0x11;p+=5;}
					else if (str.startsWith("FLASH")) 
						{mTemp[mLength++] = 0x12;p+=5;}
					else if (str.startsWith("BRIGHT")) 
						{mTemp[mLength++] = 0x13;p+=5;}
					else if (str.startsWith("INVERSE")) 
						{mTemp[mLength++] = 0x14;p+=7;}
					else if (str.startsWith("OVER")) 
						{mTemp[mLength++] = 0x15;p+=4;}
					else if (str.startsWith("AT")) 
						{mTemp[mLength++] = 0x16;p+=2;}
					else if (str.startsWith("TAB")) 
						{mTemp[mLength++] = 0x17;p+=3;}
					else throw new Exception("Illegal escape sequence "+str);
				}
			}
			else
				mTemp[mLength++] = (byte)c;
