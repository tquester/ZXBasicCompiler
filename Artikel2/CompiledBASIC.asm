...
Line10:                                ; CLEAR 30000
Line10_1:                              ; GO SUB 9000
Line20:                                ; PRINT user30000
...
Line3700_3:                            ; RETURN
Line9000:                              ; RESTORE 9010
Line9000_1:                            ; FOR a=1 TO 2
   LD   DE,256                         ; STEP not present - assume 1.
   CALL StackShortInt
   ...
   LD   DE,(Var_a)                     ; Address the var in VARS area
   LD   BC,Line9000_2                  ; Store the address of the next line
   CALL UpdateFORVar


Line9000_2:                            ; READ b,c
Line9000_3:                            ; FOR d=b TO b+c-1
   LD   DE,256                         ; STEP not present - assume 1.
   CALL StackShortInt

   LD   HL,(Var_b)                     ; Address the var in VARS area
   CALL StackNumericVar
   ...
   LD   DE,(Var_d)                     ; Address the var in VARS area
   LD   BC,Line9000_4                  ; Store the address of the next line
   CALL UpdateFORVar


Line9000_4:                            ; READ c
Line9000_5:                            ; POKE d,c
   LD   HL,(Var_d)                     ; Address the var in VARS area
   CALL StackNumericVar
...
AllocateVars:
   ...
   LD   BC,126                         ; Allocate space for Variables
