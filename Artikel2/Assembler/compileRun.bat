...
"E:/Emulator/z80/dev/sjasmplus-1.20.2.win/sjasmplus.exe" "C:\workspaces\github\ZXBasicCompiler\Artikel2\Assembler\main.asm" 2> C:\workspaces\github\ZXBasicCompiler\Artikel2\Assembler\log.txt
