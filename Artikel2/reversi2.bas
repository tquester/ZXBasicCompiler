...
30 CLEAR 30000
40 DIM B(8,8): DIM M(64,2): DIM BACKUP(8,8)
...
3030 PRINT "Col (1-8): ";
3040 INPUT C$
3050 LET ROW=CODE R$-64
3060 LET COL=VAL C$
3070 IF ROW<1 OR ROW>8 OR COL<1 OR COL>8 THEN GOTO 3010
3080 IF B(ROW,COL)<>EMPTY THEN PRINT "Occupied!": GOTO 3010
3090 LET I=ROW: LET J=COL
3100 GO SUB 1100
3110 IF VALID=0 THEN PRINT "Invalid move!": GOTO 3010
3120 GO SUB 3200: REM MAKE MOVE
3130 RETURN
