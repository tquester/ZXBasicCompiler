...
Var bi: Num = 3
Var ci: Num = 5
Var df: Num = 15229.5319214
Var di: Num = 15130.7999992
Var dx: Num = -1
Var dy: Num = -1
Var i: NumFOR = 4478, 5000, 1, 1005, 2

# End Run-time Variables

   1 DEF FN t(a,b)=a+b: DEF FN u(a,b)=FN t(a,a)+FN t(b,b)
...
3180 NEXT j
3190 NEXT i
3200 PRINT INK 1;AT 0,0;"UDG:\a\b\c";
3210 RETURN
3300 CLS
...
3420 IF k=49 THEN CLS : PRINT "Zeichne 5000 Punkte": GO SUB 1000: GO TO 3300
3425 IF k=50 THEN CLS : GO SUB 4000: GO SUB 3600: GO TO 3300
3430 IF k=51 THEN CLS : PRINT "Screen Scroll": PRINT "in Basic": GO SUB 1100: FOR i=1 TO 32: GO SUB 1200: NEXT i: GO SUB 3600: GO SUB 1400: GO TO 3300
3440 IF k=52 THEN CLS : GO SUB 3000: GO SUB 3600: GO TO 3300
3450 IF k=53 THEN GO SUB 4200: GO TO 3300
3460 IF k=54 THEN GO SUB 4300: GO TO 3300
3465 IF k=55 THEN GO SUB 4500: GO TO 3300
3470 IF k=56 THEN GO SUB 4800: GO TO 3300
3480 IF k=57 THEN GO SUB 5000: GO TO 3300
3485 IF k=48 THEN GO SUB 5200: GO TO 3300
3486 IF k=104 OR k=72 THEN GO SUB 5300: GO TO 3300
3487 IF k=97 OR k=65 THEN GO SUB 5500: GO TO 3300
3488 IF k=98 OR k=66 THEN GO SUB 5600: GO TO 3300
3489 IF k=99 OR k=67 THEN GO SUB 5900: GO TO 3300
3490 IF k=100 OR k=68 THEN GO SUB 6000: GO TO 3300
3491 IF k= CODE "e" OR k= CODE "E" THEN GO SUB 6100: GO TO 3300
3492 IF k= CODE "f" OR k= CODE "F" THEN GO SUB 7000: GO TO 3300
3499 GO TO 3400
3600 REM Press Key to continue
3610 PRINT AT 21,0;"Weiter mit Tastendruck";
3620 LET k= CODE INKEY$
3630 IF k=0 THEN GO TO 3620
3640 PAUSE 0
3650 RETURN
...
3730 PAUSE 0: RETURN
3740 PRINT AT 0,0;PEEK 23672;" ";PEEK 23673;" ";PEEK 23674;" ";: GO TO 3740
4000 DIM a(8,8)
4010 LET x=1
4020 FOR i=1 TO 8
4030 FOR j=1 TO 8
...
4802 GO SUB 3700: CLS : PRINT AT 0,15;"SIN und COS"
...
4844 IF c=0 THEN GO SUB 4900: LET c=51
4845 PLOT x,yf
4846 IF c=0 THEN LET c=51: GO SUB 4900
4847 LET c=c-1
4850 NEXT x
4890 GO TO 3710
4900 LET x$=STR$ xf
...
4940 NEXT i
4950 RETURN
5000 CLS : GO SUB 5450: PRINT AT 0,20;"Mandelbrot"
5001 REM float xf z1 zz zf zt zi z nf
5002 LET nf=0.0
5005 LET my=0
5010 LET xf=nf-2.0
5015 LET mx=0
5016 GO SUB 5400: PRINT AT 21,0;"x=";xf;"    ";AT 21,20;"time=";sec
5017 LET my=my+1
5020 LET yf=nf-1.0
5025 LET mx=mx+1
5030 LET zz=0.0
5035 LET zi=0.0
5040 FOR i=1 TO 100
5045 IF zz>1000.0 OR zi>1000.0 THEN GO TO 5100
5050 LET zt=zz*zz-zi*zi+xf
5060 LET zi=2.0*zz*zi+yf
5070 LET zz=zt
5080 NEXT i
5090 IF zz<2.0 THEN PLOT my,mx
5100 LET yf=yf+0.0156: IF yf<1.0 THEN GO TO 5025
5110 LET xf=xf+0.0156: IF xf<2.0 THEN GO TO 5015
5120 GO TO 3600
...
5420 RETURN
5450 LET timestart=0: GO SUB 5400: LET timestart=time: RETURN
...
5620 LET a$="123.456"
5630 LET i=1
5640 IF i>LEN a$ THEN GO TO 5800
5641 LET char= CODE a$(i)
5645 IF char=46 THEN GO TO 5700
5650 IF char<48 OR char>58 THEN GO TO 5800
5660 LET f1=f1*10+(char-48)
5670 LET i=i+1: GO TO 5640
5700 LET i=i+1
5705 IF i>LEN a$ THEN GO TO 5800
...
6110 LET f1=10: LET f2=0: GO SUB 6150
6115 LET f1=10: LET f2=10: GO SUB 6150
6120 LET f1=20: LET f2=10: GO SUB 6150
6125 LET f1=10: LET f2=20: GO SUB 6150
6130 GO TO 3600
6140 PRINT "f1=";f1;" f2=";f2;" f3=";f3
6150 PRINT "-------"
6170 PRINT f1=f2;":";f1;"=";f2;" ";: IF f1=f2 THEN PRINT "ja";
6175 PRINT ,
6180 PRINT f1<>f2;":";f1;"\#201";f2;" ";: IF f1<>f2 THEN PRINT "ja";
6185 PRINT
6190 PRINT f1<=f2;":";f1;"\#199";f2;" ";: IF f1<=f2 THEN PRINT "ja";
6195 PRINT ,
6200 PRINT f1>=f2;":";f1;"\#200";f2;" ";: IF f1>=f2 THEN PRINT "ja";
6205 PRINT
...
7005 PRINT "\#206t(a,b)=a+b:\#206u(a,b)=\#168t(a,a)+\#168t(b,b)"
7007 PRINT : PRINT
7010 PRINT "\#168u(2,2)=";FN u(2,2): PRINT "\#168u(3,3)=";FN u(3,3)
7030 PRINT "\#168t(2,3)=";FN t(2,3)
7050 GO TO 3600
9990 STOP
9991 ERASE "m";1;"run"
9992 SAVE *"m";1;"run" LINE 10
9999 SAVE "comptest11"
